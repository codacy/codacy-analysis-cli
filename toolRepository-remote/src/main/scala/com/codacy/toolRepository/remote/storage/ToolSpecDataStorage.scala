...
case class ToolSpecDataStorage(override val storageFilename: String = "tools")
  ...
  override implicit val encoder: Encoder[ToolSpec] = ToolPatternsSpecsEncoders.toolEncoder

  override implicit val decoder: Decoder[ToolSpec] = ToolPatternsSpecsEncoders.toolDecoder
}
